...
def grabSecond():
    ...
    file = open('house/cd/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.cd.soufun.com/housing/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/cd.txt', 'w')
    for i in range(10):
