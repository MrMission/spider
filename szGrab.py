...
def grabSecond():
    ...
    file = open('house/sz/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.sz.soufun.com/housing/89__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/sz/sz.txt', 'w')
    for i in range(10):
