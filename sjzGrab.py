...
def grabFirst(url):
    ...
    #test
    file = open('house/sjz/fist.txt', 'w')
...
def grabSecond():
    ...
    file = open('house/sjz/second.txt', 'w')
...
def grabPage():
    ...
    # test
    file = open('house/sjz/page.txt', 'w')
...
def main():
    ...
    url = 'http://esf.sjz.soufun.com/housing/357__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/sjz.txt', 'w')
    for i in range(10):
