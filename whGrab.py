...
def grabSecond():
    ...
    file = open('house/wh/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.wuhan.soufun.com/housing/494__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/wh.txt', 'w')
    for i in range(10):
