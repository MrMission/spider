...
def grabSecond():
    ...
    file = open('house/jn/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.jn.soufun.com/housing/386_7539_0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/jn/jn.txt', 'w')
    for i in range(10):
