...
def grabSecond():
    ...
    file = open('house/zb/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.zb.soufun.com/housing/10260__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/zb.txt', 'w')
    for i in range(10):
