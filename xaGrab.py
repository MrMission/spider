...
def grabSecond():
    ...
    file = open('house/xa/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.xian.soufun.com/housing/478__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/xa/xa.txt', 'w')
    for i in range(10):
