...
def grabSecond():
    ...
    file = open('house/gz/second.txt', 'w')
...
def main():
    start = time()
    url = 'http://esf.gz.soufun.com/housing/73__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/gz/gz.txt', 'w')
    for i in range(10):
