...
def grabSecond():
    ...
    file = open('house/sy/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.sy.soufun.com/housing/245__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/sy.txt', 'w')
    for i in range(10):
