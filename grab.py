...
def main():
    start = time()
    url = 'http://esf.sh.soufun.com/housing/25__0_0_0_0_1_0_0/'
    #grabFirst(url)
    #grabSecond()
    #grabPage()
    initilize()
    outFile = open('house/sh/sh.txt', 'w')
    for i in range(10):
