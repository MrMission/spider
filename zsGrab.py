...
def grabSecond():
    ...
    file = open('house/zs/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.zs.soufun.com/housing/691__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/zs.txt', 'w')
    for i in range(10):
