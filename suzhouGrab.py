...
def grabFirst(url):
    ...
    #test
    file = open('house/suzhou/fist.txt', 'w')
...
def grabSecond():
    ...
    file = open('house/suzhou/second.txt', 'w')
...
def grabPage():
    ...
    # test
    file = open('house/suzhou/page.txt', 'w')
...
def initilize():
    inFileName = 'house/suzhou/page.txt'
...
def main():
    ...
    url = 'http://esf.suzhou.soufun.com/housing/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/suzhou/suzhou.txt', 'w')
    for i in range(10):
