...
def grabSecond():
    ...
    file = open('house/yc/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.yinchuan.soufun.com/housing/11701__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/yc.txt', 'w')
    for i in range(10):
