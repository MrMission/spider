...
def grabSecond():
    ...
    file = open('house/hz/second.txt', 'w')
...
def main():
    ...
    url = 'http://esf.hz.soufun.com/housing/151__0_0_0_0_1_0_0/'
    grabFirst(url)
    grabSecond()
    grabPage()
    initilize()
    outFile = open('house/hz/hz.txt', 'w')
    for i in range(10):
